...
const formDataURL = ['/admin/category/add-category', '/admin/category/change-category-image', '/admin/mood-meter/add', '/admin/mood-meter/update-image', '/mood-master/create', '/mood-master/image-update','/admin-blog-manage/add','/admin/mood-equelizer/create','goodmood/awarness/image-upload','goodmood/post/image','goodmood/equalizer/upload','goodmood/equalizer/banner/update'];
