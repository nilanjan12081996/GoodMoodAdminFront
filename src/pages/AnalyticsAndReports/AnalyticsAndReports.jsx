...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    ...
    dispatch(getAppointmentsByDateRange({ startDate, endDate }));
  }, [dispatch]);
  ...
  const handleStartDateChange = (e) => {
    ...
    if (newStart && endDate) {
      dispatch(getAppointmentsByDateRange({ startDate: newStart, endDate }));
    }
  };
  ...
  const handleEndDateChange = (e) => {
    ...
    setEndDate(newEnd);
    if (startDate && newEnd) {
      dispatch(getAppointmentsByDateRange({ startDate, endDate: newEnd }));
    }
  };
  ...
  return (
    <div className="p-8 bg-gray-50 min-h-screen font-sans text-gray-800">
      ...
      {/* 1. FULL WIDTH Overview Bar Chart */}
      ...
      {/* 2. SIDE-BY-SIDE SECTION: Appointments (Wider) & Donut Chart */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
        
        {/* Recent Appointment Requests Card (Expanded to lg:col-span-7) */}
            ...
            <div className="max-h-[380px] overflow-y-auto pr-2 space-y-4">
              {appointmentList && appointmentList.length > 0 ? (
                ...
                <div className="text-center py-16 text-gray-400 text-sm">
                  No appointment requests found between {startDate} and {endDate}.
                </div>
              )}
            </div>
          </div>
        ...
        {/* Support Requests Donut Chart (Placed beside appointments in lg:col-span-5) */}
